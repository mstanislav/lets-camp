class SuppliesItemController < UIViewController
  ...
  def viewDidLoad
    ...
    @name = create_text_field(placeholder: 'e.g. Tent or Firewood', frame: [[10, 40], [300, 30]])

    create_label(label: 'Enter a quantity', frame: [[10, 80], [300, 30]])
    @quantity = create_text_field(placeholder: 'e.g. 1 or 2 Bundles', frame: [[10, 110], [300, 30]])
  end
